...
class Loads {
  ...
  factory Loads.fromJson(Map<String, dynamic> json) => Loads(
        ...
        settlementStatus:
            json["settlementStatus"] == null ? null : json["settlementStatus"],
        settlementFinalDt: json["settlementFinalDt"] == null
            ? null
            : json["settlementFinalDt"],
        driverOriginCity:
            json["driverOriginCity"] == null ? null : json["driverOriginCity"],
        settlementPaidDt:
            json["settlementPaidDt"] == null ? null : json["settlementPaidDt"],
        driverOriginSt:
            json["driverOriginSt"] == null ? null : json["driverOriginSt"],
        ...
        driver1FirstName:
            json["driver1FirstName"] == null ? null : json["driver1FirstName"],
        driver1LastName:
            json["driver1LastName"] == null ? null : json["driver1LastName"],
        driver2Id: json["driver2Id"] == null ? null : json["driver2Id"],
        driver2FirstName:
            json["driver2FirstName"] == null ? null : json["driver2FirstName"],
        driver2LastName:
            json["driver2LastName"] == null ? null : json["driver2LastName"],
      );
}
