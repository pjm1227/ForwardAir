...
TractorData tractorDataFromJson(String str) =>
    TractorData.fromJson(json.decode(str));
...
class TractorData {
  ...
  factory TractorData.fromJson(Map<String, dynamic> json) => TractorData(
        ...
        tractors: json["tractors"] == null
            ? null
            : List<Tractor>.from(
                json["tractors"].map((x) => Tractor.fromJson(x))),
      );
...
class Tractor {
  ...
  factory Tractor.fromJson(Map<String, dynamic> json) => Tractor(
        ...
        totalMilesPercent: json["totalMilesPercent"] == null
            ? 0.0
            : json["totalMilesPercent"].toDouble(),
        totalLoadsPercent: json["totalLoadsPercent"] == null
            ? 0.0
            : json["totalLoadsPercent"].toDouble(),
        totalNetPercent:
            json["totalNetPercent"] == null ? 0.0 : json["totalNetPercent"],
        totalGallonsPercent: json["totalGallonsPercent"] == null
            ? 0.0
            : json["totalGallonsPercent"].toDouble(),
        totalFuelCostPercent: json["totalFuelCostPercent"] == null
            ? 0.0
            : json["totalFuelCostPercent"].toDouble(),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "totalNet": totalNet == null ? 0.0 : totalNet,
        "totalMilesPercent":
            totalMilesPercent == null ? 0.0 : totalMilesPercent,
        "totalLoadsPercent":
            totalLoadsPercent == null ? 0.0 : totalLoadsPercent,
        "totalNetPercent": totalNetPercent == null ? 0.0 : totalNetPercent,
        "totalGallonsPercent":
            totalGallonsPercent == null ? 0.0 : totalGallonsPercent,
        "totalFuelCostPercent":
            totalFuelCostPercent == null ? 0.0 : totalFuelCostPercent,
      };
}
