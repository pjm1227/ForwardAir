...
FuelDetailModel fuelDetailFromJson(String str) =>
    FuelDetailModel.fromJson(json.decode(str));

String fuelDetailToJson(FuelDetailModel data) => json.encode(data.toJson());

class FuelDetailModel {
  String companyCd;
  String contractorCd;
  int month;
  int weekStart;
  ...
  factory FuelDetailModel.fromJson(Map<String, dynamic> json) =>
      FuelDetailModel(
